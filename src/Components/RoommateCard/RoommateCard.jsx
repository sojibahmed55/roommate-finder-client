...
//     rounded-[28px] shadow-[0_28px_80px_rgba(143,120,72,0.25)] 
//     border border-[#e2d6bf] dark:border-[#333] 
...
//   {/* Title */}
//   <h5 className="mt-6 mb-3 text-2xl font-semibold tracking-tight 
//       text-[#161616] dark:text-white line-clamp-1">
//     {title}
//   </h5>

//   {/* Rent + Availability */}
//   <div className="flex justify-between items-center pb-6 text-sm 
...
//         ${isAvailable
//           ? "bg-green-50 text-green-600 dark:bg-green-50 dark:text-green-600"
//           : "bg-red-50 text-red-600 dark:bg-red-900 dark:text-red-200"
//         }`}
//     >
//       {isAvailable ? <FaCheckCircle className='text-xl' /> : <FaTimesCircle className='text-xl' />}
...
//     <p className="flex items-center gap-2 line-clamp-1 font-medium">
//       <FaHome className="text-[#8f7848] dark:text-[#8f7848] text-xl" />
//       {roomType}
//     </p>
//   </div>

//   {/* Button (same as before, subtle dark tweak) */}
//   <Link
//     to={`/roommate-details/${_id}`}
//     className="relative inline-block px-6 py-3 font-semibold group mt-6"
//   >
...
//     ></span>
//     <span
//       className="relative text-[#161616] dark:text-black tracking-wide"
//     >
//       See More
//     </span>
//   </Link>
